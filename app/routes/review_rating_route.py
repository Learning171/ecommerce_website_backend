...
def create_new_review_for_product(review_create: ReviewCreate, db: db_dependency):
...
def read_review_for_product(product_id: int, review_id: int, db: db_dependency):
